...
global.reloadHandler = function () {
  ...
  conn.welcome = '┏━─━─━─━─━─\n┃──〘 (づ￣ ³￣)づ 𝑾𝑬𝑳𝑪𝑶𝑴𝑬 〙──\n┃━─━─━─━─━─━─\n┃ *_🥀 @user bienvenid@ a_* \n┃ *_@subject 🌙_*\n┃\n┃=> *_En este grupo podrás_*\n┃ *_encontrar:_*\n┠⊷ *Amistades 🫂* \n┠⊷ *Desmadre 😎* \n┠⊷ *Relajo 🥀* \n┠⊷ *Enemig@s 🤬* \n┠⊷ *Un Bot Ree Sexy 🥵*\n┃\n┃=> *_Puedes solicitar mi lista de comandos & el pack de los admins con:_*\n┠⊷ *#menu*\n┃\n┃=> *_Aquí tienes la descripción_* \n┃ *_del grupo, léela!!_*\n┃\n\n@desc\n\n┃ \n┃ *_🔰  Disfruta de el grupo tilin  🔰_*  \n┃\n┗━─━─━─━─'
  conn.bye = '┏━─━─━─━─━─\n┃──〘 𝑨𝑫𝑰𝑶𝑺 (¯―¯٥) 〙───\n┃─━─━─━─━─\n┃ *_☠ Salió un puto llamado @user_* \n┃ *_Que lo viole un burro🤑_* \n┃ *_Y no vuelva jamás🙄_*\n┗━─━─━─━─━─'
